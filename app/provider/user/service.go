...
func (u *UserService) SendRegisterMail(ctx context.Context, user *User) error {
	logger := u.container.MustMake(contract.ZapLogKey).(contract.ZapLoger)
...
func NewUserService(params ...interface{}) (interface{}, error) {
	...
	logger := container.MustMake(contract.ZapLogKey).(contract.ZapLoger)
