...
// NewHtdSingleLog params sequence: level, ctxFielder, Formatter, map[string]interface(folder/file)
func NewHtdSingleLog(params ...interface{}) (interface{}, error) {
