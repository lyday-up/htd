...
// HtdRedis 代表hade框架的redis实现
type HtdRedis struct {
...
// NewHtdRedis 代表实例化Client
func NewHtdRedis(params ...interface{}) (interface{}, error) {
...
func (app *HtdRedis) GetClient(option ...contract.RedisOption) (*redis.Client, error) {
	// 读取默认配置
